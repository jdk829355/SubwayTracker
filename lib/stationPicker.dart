...
class _StationPickerState extends State<StationPicker> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SimpleController>(builder: (controller) {
      ...
      if (controller.currentStationNm.value != controller.stationToGetOff) {
      ...
      if (controller.currentStationList.length == 1) {
        controller.selectedStation = controller.currentStationListString.last;
      }
                              ...
                              children: [
                                Flexible(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                        "${controller.currentStationNm.value}",
                                ...
                                Flexible(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Image(
                                      image: AssetImage('downMovingArrow.gif'),
                                    ),
                                  ),
                                ),
                                Flexible(
                                      ...
                                      onSelectedItemChanged: (i) {
                                        setState(() {
                                          controller.selectedStation =
                                              stationList[i];
                                          print(Get.find<SimpleController>()
                                              .selectedStation);
                                          controller.update();
                                        });
                                      },
                                      itemExtent: 80,
                                      children: controller.currentStationList),
                                ),
                              ]),
                        )
                      ],
                ...
                child: Opacity(
                    ...
                    child: Container(
                      ...
                      color: Color(Get.find<SimpleController>()
                          .ColorList[Get.find<SimpleController>().scannedLine]),
